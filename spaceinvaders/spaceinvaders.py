#This is a space invaders game made with Python 3.6
#import all the libraries/module stuff
import os
import turtle
import random
import winsound
...
window.title("SPACE INVADERS PYTHON")
